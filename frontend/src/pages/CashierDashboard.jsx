            ...
            <div className="flex-1 flex flex-col overflow-hidden animate-slide-in">
                          ...
                          <div className="flex flex-col sm:flex-row gap-3">
                            <div className="flex-1 grid grid-cols-3 gap-2">
                              {[
                                ...
                                { id: 'gcash', label: 'GCash', icon: <img src="/gcash-logo.png" className="h-5 sm:h-6 object-contain" alt="GCash" /> },
                                { id: 'maya', label: 'Maya', icon: <img src="/maya-logo.jpg" className="h-5 sm:h-6 object-contain" alt="Maya" /> }
                              ].map(m => (
                                <button
                                  key={m.id}
                                  type="button"
              ...
              <div className="print-only receipt-container">
                <div className="receipt-header">
                  <span className="receipt-logo">{user?.tenantName || "Weegol's"}</span>
